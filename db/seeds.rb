...
# users
User.create(username: 'Maruf', password: '123456')
User.create(username: 'Varvara', password: '123456')

Mealplan.create(days: 'Monday')
Mealplan.create(days: 'Tueday')
Mealplan.create(days: 'Wednesday')
Mealplan.create(days: 'Thursday')
Mealplan.create(days: 'Friday')
Mealplan.create(days: 'Saturday')
Mealplan.create(days: 'Sunday')
...
r1 = Recipe.create(name:"Tuna Avocado Salad",img:"https://images.eatthismuch.com/site_media/img/924619_Tahirah_Fo_Ferah_be330bb4-505c-4ea2-b074-26ad678577a2.jpg", ingredients:"1/4 avocado, 3oz tuna", instructions:"Using a fork, mash up the tuna really well until the consistency is even. Mix in the avocado until smooth. Add salt and pepper to taste. Enjoy!",calories: 124, fat: 6,
carbohydrates: 4,
protein: 15,
fiber: 3,
servings: 1)
